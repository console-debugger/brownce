...
const EditQuestion = ({ navigation, route }) => {
    ...
    const { EDIT_YOUR_QUESTION_AND_POST, WRITE_YOUR_QUESTION } = state['localeReducer']['locale']
        ...
        <SafeArea style={{ paddingTop: -useSafeAreaInsets().top }}>
            <MyView style={styles['mainContainer']}>
                ...
                <KeyboardAwareScroll contentContainerStyle={{ alignItems: 'center', backgroundColor: LIGHT_WHITE }}>
                    ...
                    <MyText style={styles['title']}>{EDIT_YOUR_QUESTION_AND_POST}</MyText>
                    <MultilineTextInput

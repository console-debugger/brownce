...
import { validateEmailOtpAction } from '../../redux/action'
...
const ValidateOTP = ({ navigation, route }) => {
    ...
    // handling focus of input during onchange
    ...
    const _verifyOtp = () => {
        ...
        dispatch(validateEmailOtpAction(param))
    }
    ...
    return (
        <KeyboardAwareScroll mainContainer={styles['commonContainer']}>
            ...
            <Button title={SUBMIT} style={styles['buttonStyle']} onPress={_validateOtp} />
